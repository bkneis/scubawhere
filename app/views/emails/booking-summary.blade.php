									...
									<tr>
										<td class="mini-block">
											...
											@if($booking->lead_customer->phone)
												Telephone : {{{$booking->lead_customer->phone}}}<br />
											@endif
										</td>
									</tr>
								</table>
								...
								<table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
									<tr>
										<td class="mini-block">
											...
											<span class="header-sm"><strong>{{$booking->reference}}</strong></span><br />
											<br />
											Booking Date<br />
											<span class="header-sm"><strong>{{friendlyDateNoTime($booking->created_at_local)}}</strong></span>
										</td>
									</tr>
								</table>
							</td>
							...
							<td class="item-table">
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									@if(!isObjectEmpty($booking->bookingdetails))
										<tr>
											<td style="width:100%" class="title-dark">
												 Trips &amp; Classes
											</td>
										...
										@foreach($booking->bookingdetails as $detail)
											<tr>
												<td class="item-col" colspan="3">
													<table cellspacing="0" cellpadding="0" width="100%">
														<tr>
															<td style="padding-bottom:10px;" class="item-col-inner title">
																...
																<span style="color: #4d4d4d; font-size: 14px; display: block; margin-top: 5px; margin-bottom: -15px;"> <!-- ml 28px -->
																	@if($detail->temporary)
																		No date set
																	@else
														...
														<tr>
															<td class="item-col-inner item" style="padding-left: 28px;">
																<table cellspacing="0" cellpadding="0" width="100%">
																	<tr>
																		<td style="padding-bottom: 20px !important; padding-right: 10px !important;">
																	...
																	@if(!empty($detail->packagefacade))
																		<tr>
																			...
																			<td style="padding-bottom: 20px !important;">
																				{{{$detail->packagefacade->package->name}}}
																			</td>
																		</tr>
																	@endif
																</table>
