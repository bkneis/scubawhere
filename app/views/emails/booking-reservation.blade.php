...
@section('title')
	<title>{{$company->name}} Booking Reservation</title>
@stop
	...
	<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%" style="max-width: 800px;">
		<tr>
			<td align="center" valign="top" width="100%" class="content-padding">
				<center>
					<h1 align="center">{{$company->name}} Booking Reservation</h1>
							...
							<td class="mini-container-right mini-block-padding">
								<table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
									<tr>
										<td class="mini-block">
											Please Note<br />
											<span class="header-sm">THIS IS NOT A BOOKING CONFIRMATION, IT IS A RESERVATION SUMMARY</span>
											<br />
