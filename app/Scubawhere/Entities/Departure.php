...
class Departure extends Ardent {
	...
	{
		return $this->hasMany('\Scubawhere\Entities\Bookingdetail', 'session_id');
	}

	public function customers()
	{
		return $this->belongsToMany('\Scubawhere\Entities\Customer', 'booking_details', 'session_id', 'customer_id')
			->withPivot('ticket_id')
			->withTimestamps();
	}
	...
	{
		return $this->belongsTo('\Scubawhere\Entities\Trip')->withTrashed();
	}

	public function boat()
	{
		return $this->belongsTo('\Scubawhere\Entities\Boat')->withTrashed();
	}

	public function bookings()
	{
		return $this->belongsToMany('\Scubawhere\Entities\Booking', 'booking_details', 'session_id', 'booking_id')
	...
	{
		return $this->belongsTo('\Scubawhere\Entities\Timetable');
	}
}
