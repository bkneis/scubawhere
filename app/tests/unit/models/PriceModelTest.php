...
class PriceModelTest extends ModelTestCase {
	...
	public function testCRUD(){
		...
		$this->assertEquals(ModelTestHelper::TEST_PRICE, $price->price, "Unexpected price value");
		...
		$this->assertEquals(ModelTestHelper::TEST_PRICE_UPDATED, $price->price, "Unexpected price value");
	...
	public function testFunctions(){
		...
		$this->assertEquals(ModelTestHelper::TEST_INTEGER, $price->decimal_price, "Unexpected decimal_price value");
	}
