...
class CompanyModelTest extends ModelTestCase {
	...
	public function testCRUD(){
		...
		$this->assertEqualsDecimal(ModelTestHelper::TEST_LATITUDE, $company->latitude, "Unexpected latitude value", 0.000001);//Delta required for decimals
		$this->assertEqualsDecimal(ModelTestHelper::TEST_LONGITUDE, $company->longitude, "Unexpected longitude value", 0.000001);//Delta required for decimals
		$this->assertEquals(ModelTestHelper::TEST_TIMEZONE, $company->timezone, "Unexpected timezone value");
		...
		$company->latitude            = ModelTestHelper::TEST_LATITUDE_UPDATED;
		$company->longitude           = ModelTestHelper::TEST_LONGITUDE_UPDATED;
		$company->timezone            = ModelTestHelper::TEST_TIMEZONE_UPDATED;;
		...
		$this->assertEqualsDecimal(ModelTestHelper::TEST_LATITUDE_UPDATED, $company->latitude, "Unexpected latitude value", 0.000001);//Delta required for decimals
		$this->assertEqualsDecimal(ModelTestHelper::TEST_LONGITUDE_UPDATED, $company->longitude, "Unexpected longitude value", 0.000001);//Delta required for decimals
		$this->assertEquals(ModelTestHelper::TEST_TIMEZONE_UPDATED, $company->timezone, "Unexpected timezone value");
	...
	public function testFunctions(){
		...
		$this->assertEquals(ModelTestHelper::TEST_CURRENCY, $company->currency->code, "Unexpected currency value");
		$this->assertEquals(ModelTestHelper::TEST_ABBR, $company->country->abbreviation, "Unexpected country value");
	}
