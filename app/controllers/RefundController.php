...
class RefundController extends Controller {
	...
	{
		return Auth::user()->refunds()->with('currency', 'paymentgateway')->orderBy('bookings.created_at')->skip($from)->take($take)->get();
	}
	...
	public function getFilter()
	{
		...
		return Auth::user()->refunds()->with('currency', 'paymentgateway', 'booking')->whereBetween('bookings.created_at', [$after, $before])->orderBy('bookings.created_at')->get();
	}
