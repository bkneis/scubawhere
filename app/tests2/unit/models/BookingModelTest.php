...
class BookingModelTest extends ModelTestCase {
	...
	public function testCRUD(){
		...
		$this->assertEquals(ModelTestHelper::TEST_TIME, $booking->pick_up_time, "Unexpected pick_up_time value");
		...
		$booking->pick_up_time     = ModelTestHelper::TEST_TIME_UPDATED;
		...
		$this->assertEquals(ModelTestHelper::TEST_TIME_UPDATED, $booking->pick_up_time, "Unexpected pick_up_time value");
