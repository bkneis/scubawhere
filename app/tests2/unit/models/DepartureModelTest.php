...
class DepartureModelTest extends ModelTestCase {
	...
	public function testCRUD(){
		...
		$this->assertEquals(ModelTestHelper::TEST_DATETIME, $departure->start, "Unexpected start value");
		...
		//Update
		$departure->start = ModelTestHelper::TEST_DATETIME_UPDATED;
		$departure->save();
		$departure = Departure::find($departure_id);

		$this->assertNotEquals(0, $departure->id, "Unexpected id value");
		$this->assertEquals(ModelTestHelper::TEST_DATETIME_UPDATED, $departure->start, "Unexpected start value");
