...
use ScubaWhere\Excpetions\InternalErrorException;
...
class CustomerService implements CustomerServiceInterface {
	...
	/** 
	 *	Repository to access crm subscriptions
	...
	/**
	 * @param CustomerRepoInterface     Injected using \ScubaWhere\Repositories\CustomerRepoServiceProvider
	...
	public function getAllWithTrashed() {
		return $this->customer_repo->allWithTrashed();
	}
	 ...
	 * @param  array Data to autofill customer model
	 * @return \Customer
	 */
	...
	public function importCustomers($data) 
	{
		...
		$result = $this->extractCustomersFromCSV($customer_data, $columns);
	 ...
	 * @return array $imported_customers Array of \Customer objects created from the first parameter
	 */
	private function extractCustomersFromCSV($customer_data, $columns) 
	{
		$result             = array();
		$imported_customers = array();
		$errors             = array();
