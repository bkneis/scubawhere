...
class TrainingService {
	...
	/** 
	 *	Repository to access the training models
	 *	\ScubaWhere\Repositories\TrainingRepo
	 */
	...
	/**
	 * @param TrainingRepoInterface     Injected using \ScubaWhere\Repositories\TrainingRepoServiceProvider
	 ...
	 * @param  array Data to autofill training model
