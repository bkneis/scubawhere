	...
	<div class="row">
		...
		<script type="text/x-handlebars-template" id="add-room-template">
			<p>
				...
				Number of Rooms:
				<input type="number" name="boatRooms[{{id}}][quantity]" value="{{quantity}}" placeholder="0" style="width: 100px;" min="0">
				<button id="remove-room" class="bttn redb">&nbsp;&#215;&nbsp;</button>
			</p>
		</script>
...
<script src="tabs/boats_new/js/script.js"></script>
