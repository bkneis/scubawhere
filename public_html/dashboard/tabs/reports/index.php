		...
		<table id="class-utilisation-summary">
			<thead style="font-weight: bold;">
				<tr>
					...
					<td>
						<div style="width:100%" class="percentage-bar-container bg-success border-success">
							<div id="class-utilisation-average" class="percentage-bar" style="background-color: #5cb85c; width: {{getUtil entries.utilisation_total.capacity entries.utilisation_total.assigned}}%">{{entries.utilisation_total.assigned}}</div>
